...
/// Enable faster checksums using the algorithm described in
/// [Understanding and Using Cyclic Redundancy Checks with Dallas Semiconductor]'s
/// Dow CRC Lookup Function (Table 2)
///
/// [Understanding and Using Cyclic Redundancy Checks with Dallas Semiconductor]: <http://www.microshadow.com/files/files8051/app27.pdf>
mod crc {
    use super::Device;
